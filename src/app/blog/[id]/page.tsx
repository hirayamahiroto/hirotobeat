...
const Loading = () => (
  <div className="flex flex-col justify-center items-center h-screen bg-white">
    <div className="animate-pulse">
      <Image src="/images/logo.png" alt="logo" width={297} height={90} priority />
    </div>
...
async function BlogDetailPageContent({ id }: { id: string }) {
  try {
    ...
    return (
      <Error text="何らかの原因でエラーが発生しました。時間を空けて再度アクションをしてください。" />
    );
  }
}

export default async function BlogDetailPage({ params: { id } }: { params: { id: string } }) {
  return (
